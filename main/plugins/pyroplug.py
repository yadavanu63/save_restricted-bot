        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if msg.media==MessageMediaType.POLL:
                ...
                #await edit.delete()
                return 
            edit = await client.edit_message_text(sender, edit_id, "**Trying to Download.⬇️⬇️**")
            ...
            await edit.delete()
            upm = await client.send_message(sender, '**Preparing to Upload!⬆️⬆️**')
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg']:
                ...
                caption = msg.caption if msg.caption is not None else str(file).split("/")[-1]
                await upm.edit("**Uploading photo.⬆️⬆️**")
